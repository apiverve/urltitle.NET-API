...
namespace APIVerve
{
    public class URLTitleAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/urltitle";
        ...
        public URLTitleAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public URLTitleAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, URLTitleQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(URLTitleQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(URLTitleQueryOptions options)
        {
